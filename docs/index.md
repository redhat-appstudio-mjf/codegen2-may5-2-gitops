...
# Application
An application built from https://github.com/redhat-appstudio-mjf/codegen2-may5-2 will be stored in [quay.io/maysunfaisal/codegen2-may5-2](https://quay.io/maysunfaisal/codegen2-may5-2) and deployed through GitOps. This application is accessible on port **8501**.